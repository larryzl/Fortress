...
class AuthGroupNode(models.Model):
    uuid = models.CharField(primary_key=True,auto_created=True,default=uuid.uuid4,editable=False,max_length=50)
    department_name = models.ForeignKey(Department, max_length=20, verbose_name="名称", help_text="部门",on_delete=models.CASCADE,to_field='uuid',related_name='authdepnode_user')
